...
\subsubaim{Map Progress to Points} We need to decide how achievement at different levels maps onto an actual score. \fixme{Is there a way to do this without taking the plunge? Estimate numbers of students at each level to keep similar grade distribution if students did similar quality work? What would we look at to evaluate if it is ok or needs to change? Seems great!}
...
\subsubaim{ACS exam} ACS Gen Chem 1 Paired Question exam. (These exams were purchased in 2018 and are available in the Department.) We will compare to both national norms exam data and, perhaps more importantly, to the scores from POGIL sections in 2018 and 2019.
