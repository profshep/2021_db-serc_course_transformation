...
% Aims / objectives
\makeatletter
\newcommand{\aimtext}[2]{\label{#1}\color{black}\textbf{#2}\color{black}\xspace%
...
\newcommand{\nts}[1]{}
\newcommand{\fixme}[1]{\color{red}{\bfseries#1}\color{black}\xspace}
\newcommand{\pogil}{\caps{pogil}\xspace}
\pagestyle{fancy}
